            ...
            return (
              <div key={i} className="relative group">
                <pre className="bg-[#282a36] p-4 rounded-md my-2 overflow-x-auto">
                  <code className="text-sm font-mono text-[#f8f8f2]">
                    {code}
                  </code>
                </pre>
                <button
              ...
              {parts.map((part, j) => {
                if (j % 2 === 1) {
                  ...
                  return (
                    <code
                      key={j}
                      className="bg-[#282a36] px-1 rounded font-mono text-sm text-[#f8f8f2]"
                    >
                      {part}
                    </code>
                  );
        ...
        <div className="flex flex-col h-full p-4">
          ...
          <div className="pt-4 mt-4 border-t border-[#44475a]">
            <p className="text-sm text-[#6272a4] text-center">
              &copy; {new Date().getFullYear()} Carryu Indonesia.
              <br />
              All rights reserved.
            </p>
          </div>
      ...
      <div className="flex-1 flex flex-col h-[100dvh] max-h-screen">
        <div className="shrink-0 p-4 border-b border-[#44475a] bg-[#282a36]">
          <div className="flex flex-col items-center justify-center ">
            ...
            <h3 className="text-[#ffffff]">(llama3-8b-8192)</h3>
          </div>
        </div>
